...
const BranchesPage = () => {
  ...
  const branches = {
    komaMambal: {
      id: 'komaMambal',
      name: 'Koma Mambal',
      hero: 'https://res.cloudinary.com/dpadqzd98/image/upload/v1780171603/koma-mambal-carousel2_uwehlm.jpg?w=1600',
    ...
    komaPoint: {
      id: 'komaPoint',
      name: 'Koma Point',
      hero: 'https://res.cloudinary.com/dpadqzd98/image/upload/v1780172190/koma-point_fgy6tg.png?w=1600',
